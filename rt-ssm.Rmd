...
mod_fit_filtered = KFS(mod_fit$model, c("state", "mean"), c("state", "mean"))

cbind(fitted(mod_fit_filtered), log(itp1)) %>% ts.plot(col = c("red", "blue"))
